...
import de.energiequant.vatsim.compatibility.legacyproxy.server.DirectProxy;
import de.energiequant.vatsim.compatibility.legacyproxy.server.IPFilter;
import de.energiequant.vatsim.compatibility.legacyproxy.server.InjectingLegacyNetworkInformationProxy;
import de.energiequant.vatsim.compatibility.legacyproxy.server.JsonToLegacyDataFileProxy;
import de.energiequant.vatsim.compatibility.legacyproxy.server.SimpleErrorResponse;
