...
- The official workaround is to fetch the locations of all Audio for VATSIM transceiver locations from a separate file and calculate a center point for each station. This method is referred to as *"Online Transceivers"* throughout the proxy application (available since version 0.95).
